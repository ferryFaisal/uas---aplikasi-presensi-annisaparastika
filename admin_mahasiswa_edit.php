...
if (isset($_GET['id'])) {
  ...
  if (!count($data)) {
    echo "<script>alert('Data tidak ditemukan pada database');window.location='admin_mahasiswa_table.php';</script>";
  }
} else {
  echo "<script>alert('Masukkan data id.');window.location='admin_mahasiswa_table.php';</script>";
}
?>
<!DOCTYPE html>
<html lang="en">
...
<body class="bg-dark">
    ...
    <div class="container">
        <div class="card card-register mx-auto mt-5">
            ...
            <div class="card-body">
                <form method="POST" action="proses_mahasiswa_edit.php" enctype="multipart/form-data">
                <section class="base">
