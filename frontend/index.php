...
<body class="bg-dark">
    ...
    <div class="card card-register mx-auto mt-5">
      ...
      <a class="btn btn-primary" href="../logout_proses.php" role="button">Logout</a>
    </button>
    <?php
...
echo "<center><h5>Selamat Datang, ". $_SESSION['name'] ."</h5></center>";
}?>
                   <br>
        ...
        <div class="text-center">
          <br>Copyright © Annisa Parastika Adellia- UAS 5A -Program Studi Teknik Informatika - <?= date('Y');?><br>
        </div>
      </div>
    </div>
